...
# This file auto-generated by: ./development-helpers.bash build-sdk-bootstrapper ; VERSION=v2.6.1; DATE=2019-10-08--00:24

export LC_ALL="en_US.UTF-8"

# HELPERS BEGIN
INSTALLER_VERSION='v2.6.1'
INSTALLER_BUILD_DATE='2019-10-08'
# helpers/arrays.bash
#!/usr/bin/env bash
