...
# This file auto-generated by: ./development-helpers.bash build-sdk-bootstrapper ; VERSION=v1.141.0; DATE=2019-08-20--19:07

export LC_ALL="en_US.UTF-8"

# HELPERS BEGIN
INSTALLER_VERSION='v1.141.0'
INSTALLER_BUILD_DATE='2019-08-20'
# helpers/arrays.bash
#!/usr/bin/env bash
