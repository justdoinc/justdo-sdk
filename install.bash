...
# This file auto-generated by: ./development-helpers.bash build-sdk-bootstrapper ; VERSION=v2.8.11; DATE=2019-11-01--18:22

export LC_ALL="en_US.UTF-8"

# HELPERS BEGIN
INSTALLER_VERSION='v2.8.11'
INSTALLER_BUILD_DATE='2019-11-01'
# helpers/arrays.bash
#!/usr/bin/env bash
