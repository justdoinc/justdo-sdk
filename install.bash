...
# This file auto-generated by: ./development-helpers.bash build-sdk-bootstrapper ; VERSION=v3.18.2; DATE=2020-02-03--17:58

export LC_ALL="en_US.UTF-8"

# HELPERS BEGIN
INSTALLER_VERSION='v3.18.2'
INSTALLER_BUILD_DATE='2020-02-03'
# helpers/arrays.bash
#!/usr/bin/env bash
