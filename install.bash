...
# This file auto-generated by: ./development-helpers.bash build-sdk-bootstrapper ; VERSION=v2.8.0; DATE=2019-10-17--18:49

export LC_ALL="en_US.UTF-8"

# HELPERS BEGIN
INSTALLER_VERSION='v2.8.0'
INSTALLER_BUILD_DATE='2019-10-17'
# helpers/arrays.bash
#!/usr/bin/env bash
...
if ! dockerRequireAvailableGiBMemory 2.9; then 
    announceErrorAndExit "On Mac, go to: Docker preferences' Advanced tab and set a value >= 3GiB"
...
cd "$output_folder"
    ...
    export JUSTO_SKIP_REINSTALL="true"
