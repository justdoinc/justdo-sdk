...
# This file auto-generated by: ./development-helpers.bash build-sdk-bootstrapper ; VERSION=v2.8.2; DATE=2019-10-18--00:10

export LC_ALL="en_US.UTF-8"

# HELPERS BEGIN
INSTALLER_VERSION='v2.8.2'
INSTALLER_BUILD_DATE='2019-10-18'
# helpers/arrays.bash
#!/usr/bin/env bash
