...
# This file auto-generated by: ./development-helpers.bash build-sdk-bootstrapper ; VERSION=v1.138.0-1-g20e5c1f; DATE=2019-08-06--17:29

# HELPERS BEGIN
INSTALLER_VERSION='v1.138.0-1-g20e5c1f'
INSTALLER_BUILD_DATE='2019-08-06'
# helpers/arrays.bash
#!/usr/bin/env bash
...
# If mac create the justdo var folder

# If mac install all brew packages

installation_root_folder="$(pwd)/justdo"

announceStep "JustDo installed successfully under: $installation_root_folder ."
...
#
# Setup into /usr/local/bin
#

#
# Check whether /etc/hosts needs an update
#
